    ...
    <div class="admin-management">
        <div class="sidebar">
            ...
            <div class="menu-container">
                ...
                <div onclick="redirectTo('film-management')" class="<?php echo isset($_GET['handle']) && $_GET['handle'] == 'film-management' ? 'menu-item menu-item-active' : 'menu-item menu-item-default'; ?>">
                    <div class="menu-item-content">
