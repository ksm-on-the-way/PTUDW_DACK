...
while ($rows = mysqli_fetch_assoc($result)) {
    ...
    <div onclick="redirectToFilmDetails(' . $rows['movie_id'] . ')" class="column">
        ...
        <div class="comingsoon_film_info">
            <span class = "bold_info">Thời lượng: </span><span class="info">' . $rows['movie_duration'] . ' phút</span>
        </div>
        <div class="comingsoon_film_info">
            <span class = "bold_info">Ngày khởi chiếu: </span>' . date('d/m/Y', strtotime($rows['release_date'])) . '<span class = "info"></span>
        </div>
        </div>
        </div>  
    </div>
