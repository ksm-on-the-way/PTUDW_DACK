...
<body>
    ...
    $query = "SELECT m.movie_name, m.movie_duration, md.movie_director_name, mg.movie_genre_name, mr.movie_rate_name, mi.image_url
            FROM movies m
            ...
            LEFT JOIN movie_banner_images mi ON m.movie_id = mi.movie_id 
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        <div class="film-container">
            <img loading="lazy" src="' . $row['image_url'] . '" class="img" />
    ...
    timeItems.forEach(function(item) {
        item.addEventListener('click', function() {
            ...
            var showObject = {
                ...
                film_name: document.querySelector('.film-container .name').textContent,
                show_id: showId
            }
...
function redirecToPickSeats() {
    ...
    var showId = document.querySelector('.time-item.active').getAttribute('show-id')
    window.location.href = 'seat.php?show_id=' + showId;
}
